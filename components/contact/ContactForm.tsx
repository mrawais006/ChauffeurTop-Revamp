                                ...
                                <form onSubmit={handleSubmit} className="space-y-4" suppressHydrationWarning>
                                    <div className="space-y-1">
                                        ...
                                        <input
                                            ...
                                            required
                                            disabled={loading}
                                            className={`w-full h-10 bg-white/5 border rounded px-4 text-white text-sm placeholder:text-white/30 focus:outline-none transition-all disabled:opacity-50 disabled:cursor-not-allowed ${
                                                errors.name 
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <textarea
                                            ...
                                            required
                                            disabled={loading}
                                            className={`w-full bg-white/5 border rounded px-4 py-3 text-white text-sm placeholder:text-white/30 focus:outline-none transition-all resize-none disabled:opacity-50 disabled:cursor-not-allowed ${
                                                errors.message 
                                                    ? 'border-red-500/50 focus:border-red-500' 
                                                    : 'border-white/10 focus:border-luxury-gold'
                                            }`}
